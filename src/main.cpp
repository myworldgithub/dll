...
int64 nChainStartTime = 1526523235;
...
const string strMessageMagic = "TheBeltandRoadInitiative Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TheBeltandRoadInitiative
    bool fStrictPayToScriptHash = true; // Always active in TheBeltandRoadInitiative
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TheBeltandRoadInitiative", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector TheBeltandRoadInitiative empty mapBlockIndex TheBeltandRoadInitiative TheBeltandRoadInitiative";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x4fab88e7836506af871f9aab24c25a48494ed0059bbb94c75ae8e50c4883a1c3"));
