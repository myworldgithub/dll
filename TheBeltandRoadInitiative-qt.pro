TEMPLATE = app
TARGET = TheBeltandRoadInitiative-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = TheBeltandRoadInitiative-qt_test
...
macx:ICON = src/qt/res/icons/TheBeltandRoadInitiative.icns
macx:TARGET = "TheBeltandRoadInitiative-Qt"
